...
import {
  ...
  PointPortModel, DiagramConstraints, SymbolInfo, PaletteModel, SymbolPreviewModel, SnapSettingsModel,
...
export class CircuitDisplayComponent {
  ...
  public flipPorts: PointPortModel[] = [{ offset: { x: 0.01, y: 0.215 } }, { offset: { x: 0.01, y: 0.785 } }, { offset: { x: 0.99, y: 0.215 } }, { offset: { x: 0.99, y: 0.785 } }];
  public jkPorts: PointPortModel[] = [{ offset: { x: 0.01, y: 0.27 } }, { offset: { x: 0.01, y: 0.5 } }, { offset: { x: 0.01, y: 0.73 } }, { offset: { x: 0.99, y: 0.27 } }, { offset: { x: 0.99, y: 0.73 } }, { offset: { x: 0.5, y: 0.01 } }, { offset: { x: 0.5, y: 0.99 } }];
  public rPorts: PointPortModel[] = [{ offset: { x: 0.01, y: 0.215 } }, { offset: { x: 0.01, y: 0.785 } }, { offset: { x: 0.5, y: 0.215 } }, { offset: { x: 0.99, y: 0.215 } }, { offset: { x: 0.99, y: 0.785 } }];
  ...
  public items: (NodeModel | ConnectorModel)[] = [
    { id: 'Or', shape: { type: 'Path', data: this.orData }, ports: this.orPort },
    {
      id: 'Nor',
      shape: {
    ...
    { id: 'And', shape: { type: 'Path', data: this.andData }, ports: this.andPort },
    {
      id: 'Nand',
      shape: {
    ...
    { id: 'not', shape: { type: 'Path', data: this.notData }, ports: this.notPort },
    {
    ...
    {
      id: 'ChEmitter', ports: this.orPort,
      shape: {
    ...
    {
      id: 'NandGate1', ports: this.jkPorts,
      shape: {
    ...
    {
      id: 'Flipflop', ports: this.flipPorts,
      shape: {
    ...
    {
      id: 'RSLatch', ports: this.flipPorts,
      shape: {
    ...
    {
      id: 'RSLatchSync', ports: this.rPorts,
      shape: {
    ...
    {
      id: 'JKflipflop', ports: this.jkPorts,
      shape: {
    ...
    {
      id: 'Dflipflop', ports: this.flipPorts,
      shape: {
